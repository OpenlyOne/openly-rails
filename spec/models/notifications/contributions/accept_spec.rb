...
RSpec.describe Notifications::Contributions::Accept, type: :model do
  ...
  describe '#source' do
    ...
    before { allow(contribution).to receive(:acceptor).and_return 'acceptor' }

    it { is_expected.to eq 'acceptor' }
  end
  ...
  describe '#title' do
    ...
    it { is_expected.to eq 'User accepted a contribution in Project' }
  end
end
