...
RSpec.describe FileItems::Presentation, type: :model do
  subject(:file) { build(:file_items_presentation) }
  ...
  describe '#external_link' do
    ...
    context "when google drive id is 'abc'" do
      ...
      it { is_expected.to eq 'https://docs.google.com/presentation/d/abc' }
    end

    context "when google drive id is '1234'" do
      before { file.google_drive_id = '1234' }
      it { is_expected.to eq 'https://docs.google.com/presentation/d/1234' }
    end
